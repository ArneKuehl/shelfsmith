...
const ISSUE_COLORS: Record<LibraryIssueKind, string> = {
  ...
  "format-duplicate": "bg-pink-100 dark:bg-pink-900/60 text-pink-800 dark:text-pink-200",
  "format-preference": "bg-pink-100 dark:bg-pink-900/60 text-pink-800 dark:text-pink-200",
